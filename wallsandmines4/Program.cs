...
namespace WallsANDmines3
{
    class Program
    {
        static void gameStarting()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("Çağrı Aydın        2021510010\nEsma Oruç          2022510140\nSelda Nur Turgut   2021510066\nBaşar Babacan      2022510060");
                Console.ReadKey();
                Console.Clear();
                return;
            }
        ...
        static void Difficulty(ref int energy, ref int mine)
        {
            bool flag = false;
            Console.Clear();
            Console.ForegroundColor = ConsoleColor.Red;
            ...
            else
            {
                ...
                Console.WriteLine("Plese enter a valid game mode!");
                Console.ReadLine();
            }
            Console.Clear();
        }
        ...
        static void Main(string[] args)
        {
            ...
            int energy = 200;
            int score  = 0;
            int mine   = 0;     // start with 5 for testing
            int kills  = 0;

            gameStarting();
            Difficulty(ref energy, ref mine);
            Console.ForegroundColor = ConsoleColor.DarkBlue;
            ...
            while (block[random_y, random_x] == 1) // eğer player duvar yerinde doğduysa tekrar seçtir
            {
            ...
            while (true)
            {
                ...
                while (wall_flag == true)
                {
                    ...
                    if (counter_for_walls >= 1)
                    {
                        ...
                        else if (current_wall < 10 & current_wall > 3)
                        {
                            ...
                            if (current_wall == 8)//8 3 de olabilir
                            {
                                if (element_of_4 == 0)
                                {
                                    randomed_wall = 0;
                            ...
                            if (current_wall == 9) // 9 3 de olabilir 
                            {
                                if (element_of_4 == 0)
                                {
                                    randomed_wall = 2;
                ...
                //add new x or y every 150 time unit
                if (counter_for_new_x_y % 150 == 0) //adding x 
                {
